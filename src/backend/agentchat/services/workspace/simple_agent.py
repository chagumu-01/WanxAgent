...
class WorkSpaceSimpleAgent:
    ...
    async def astream(self, messages: List[BaseMessage]):
        ...
        is_anthropic = isinstance(self.model, ChatAnthropic)
        ...
        if is_anthropic:
            ...
            async for chunk in self.model.astream(input=human_messages, config={"callbacks": [usage_metadata_callback]}, system=system_message):
