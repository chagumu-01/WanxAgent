  ...
  <div class="chat-page" :class="{ 'chat-active': messages.length > 0 }">
    <div class="chat-container">
      ...
      <div v-if="messages.length === 0" class="welcome-section">
        ...
        <h1 class="welcome-title">我是WanxAgent小助手，很高兴见到你！</h1>
        <p class="welcome-subtitle">
          欢迎体验WanxAgent，开启您的智能协作新纪元~
        </p>
      </div>
      ...
      <div v-if="messages.length > 0" class="chat-conversation" ref="chatConversationRef">
        <div v-for="(msg, idx) in messages" :key="idx" class="message-group">
          ...
          <div v-if="msg.role === 'user'" class="user-message">
            ...
            <img :src="getUserAvatarSrc(userStore.userInfo?.avatar)" alt="User Avatar" class="avatar" @error="handleAvatarError" />
          </div>
      ...
      <div class="input-section" :class="{ 'input-fixed': messages.length > 0 }">
        <div class="input-wrapper" :class="{ 'lingseek-glow': selectedMode === 'lingseek' }">
          <textarea
            ...
            placeholder="给WanxAgent发消息，让WanxAgent帮你完成任务~"
            class="message-input"
            rows="4"
...
.chat-page {
  ...
  background: linear-gradient(180deg, #fceef2 0%, #ffffff 100%);
  padding: 0;
  overflow-y: auto;
...
.welcome-section {
  ...
  .welcome-title {
    font-size: 32px;
    font-weight: 700;
    background: linear-gradient(135deg, #4a1a25 0%, #7a2a3a 100%);
...
.mode-selector {
  ...
  .mode-btn {
    ...
    box-shadow: 0 2px 4px rgba(196, 30, 58, 0.04);
    ...
    &.active {
      border-color: #c41e3a;
      background: linear-gradient(135deg, #f8d0d8 0%, #fceef2 100%);
      color: #c41e3a;
...
@keyframes lingseek-breath {
  0%, 100% {
    box-shadow:
      ...
      0 0 24px 10px rgba(196, 30, 58, 0.14);
  }
  50% {
    box-shadow:
      0 0 0 3px rgba(196, 30, 58, 0.22),
      0 0 44px 18px rgba(196, 30, 58, 0.22);
  }
}
...
@keyframes lingseek-breath-strong {
  0%, 100% {
    box-shadow:
      0 0 0 3px rgba(196, 30, 58, 0.20),
      0 0 36px 14px rgba(196, 30, 58, 0.24);
  }
  50% {
    box-shadow:
      0 0 0 4px rgba(196, 30, 58, 0.30),
      0 0 60px 24px rgba(196, 30, 58, 0.30);
  }
}
...
.input-section {
  ...
  .input-wrapper {
    ...
    &.lingseek-glow {
      ...
      box-shadow:
        0 0 0 2px rgba(196, 30, 58, 0.12),
        0 0 16px 6px rgba(196, 30, 58, 0.14);
      ...
      .footer-left {
        ...
        gap: 10px;
          ...
          .dropdown-menu {
            ...
            border: 1px solid #f2a5b5;
            border-radius: 12px;
            box-shadow: 0 10px 32px rgba(196, 30, 58, 0.15);
            min-width: 220px;
            z-index: 1000;
            max-height: 320px;
            overflow: hidden;
            ...
            .dropdown-footer {
              ...
              .selected-info {
                ...
                .selected-count {
                  ...
                  font-weight: 600;
                  padding: 4px 12px;
                  background: linear-gradient(135deg, #f8d0d8 0%, #fef6f8 100%);
                  border-radius: 12px;
